OUTPUT_DIR = '/local/storage/yl986/script_hub/nightly_scripts/test_data'
...
IRES_PARSED_DIR = '/local/storage/yl986/script_hub/nightly_scripts/test_data/ires/parsed_files/'  # To-Do: modify
